...
![](images/gglayers.png){fig-alt="Diagram showing the different layers of a ggplot. Working from the bottom up, the layers are labelled: Data, Aesthetics, Geometries, Facets, Statistics, Coordinates, and Themes. Each layer is represented by a colored labeled sheet."}
